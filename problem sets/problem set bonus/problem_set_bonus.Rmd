...
patients <- read_csv("../problem_set_7/data/patients.csv")
visits <- read_csv("../problem_set_7/data/visits.csv")
doctors <- read_csv("../problem_set_7/data/doctors.csv")
schedule <- read_csv("../problem_set_7/data/schedule.csv")
```
