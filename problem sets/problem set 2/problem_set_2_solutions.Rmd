...
(day <- wday(current_date, label = TRUE))
```
...
# your code here
weekdays <- days[2:6]
weekdays <- days[seq(2,6)]
weekdays <- days[c(2,3,4,5,6)]
```
...
# your code here
# https://lubridate.tidyverse.org/reference/date_decimal.html
